...
const mapConfig = [
...

    {
        ...
        name: 'Block C',
        gridArea: '11 / 3 / 12 / 4',
        style: 'height: 1150px; width: 1600px; position: relative;',
        roads: [
            { name: "ROAD1 30' WIDE ", x: 80, y: 275, width: 1470, height: 30, isVertical: false },
            { name: "ROAD2 30' WIDE", x: 1360, y: 50, width: 60, height: 215, isVertical: true },
            // Separator road between new (top) and existing (bottom) plots
            { name: "ROAD3 30' WIDE", y: 540, width: 1010, x: 80 },
            // Vertical road on the right side of plots
            { name: "ROAD4 30' WIDE", x: 1055, y: 320, width: 40, height: 467, isVertical: true },
            // Vertical road between left (251-C, 252-C, 253-C) and right (256-C, 255-C, 254-C) columns
            { name: "ROAD5 30' WIDE", x: 1245, y: 336, width: 40, height: 156, isVertical: true },
            // Vertical road on the right side of 257-C, 258-C, 259-C
            { name: "ROAD6 30' WIDE", x: 1440, y: 283, width: 40, height: 209, isVertical: true }
        ],
        plots: [
            { id: '57-S', size: '5 Marla', x: 85, y: 30, width: 100, height: 32, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '58-S', size: '5 Marla', x: 85, y: 65, width: 100, height: 32, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '59-S', size: '5 Marla', x: 85, y: 100, width: 100, height: 32, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '60-S', size: '5 Marla', x: 85, y: 135, width: 100, height: 32, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '61-S', size: '5 Marla', x: 85, y: 170, width: 100, height: 32, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '62-S', size: '5 Marla', x: 85, y: 205, width: 100, height: 32, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '63-S', size: '5 Marla', x: 85, y: 240, width: 100, height: 32, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '282-C', size: '8 Marla', x: 200, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '283-C', size: '8 Marla', x: 272, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '284-C', size: '8 Marla', x: 344, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '285-C', size: '8 Marla', x: 416, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '286-C', size: '8 Marla', x: 488, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '287-C', size: '8 Marla', x: 559, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '288-C', size: '8 Marla', x: 631, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '289-C', size: '8 Marla', x: 703, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '290-C', size: '8 Marla', x: 775, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '291-C', size: '8 Marla', x: 847, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '292-C', size: '8 Marla', x: 919, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '293-C', size: '8 Marla', x: 991, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '294-C', size: '8 Marla', x: 1062, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '295-C', size: '8 Marla', x: 1134, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '296-C', size: '8 Marla', x: 1206, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '297-C', size: '8 Marla', x: 1278, y: 30, width: 69, height: 120, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '281-C', size: '8 Marla', x: 200, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '280-C', size: '8 Marla', x: 264, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '279-C', size: '8 Marla', x: 328, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '278-C', size: '8 Marla', x: 392, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '277-C', size: '8 Marla', x: 456, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '276-C', size: '8 Marla', x: 519, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '275-C', size: '8 Marla', x: 583, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '274-C', size: '8 Marla', x: 647, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '273-C', size: '8 Marla', x: 711, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '272-C', size: '8 Marla', x: 775, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '271-C', size: '8 Marla', x: 839, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '270-C', size: '8 Marla', x: 903, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '269-C', size: '8 Marla', x: 967, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '268-C', size: '8 Marla', x: 1031, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '267-C', size: '8 Marla', x: 1094, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '266-C', size: '8 Marla', x: 1158, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '265-C', size: '8 Marla', x: 1222, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '264-C', size: '8 Marla', x: 1286, y: 155, width: 61, height: 115, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '298-C', size: '8 Marla', x: 1440, y: 35, width: 100, height: 38, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '299-C', size: '8 Marla', x: 1440, y: 75, width: 100, height: 38, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '300-C', size: '8 Marla', x: 1440, y: 115, width: 100, height: 38, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '301-C', size: '8 Marla', x: 1440, y: 155, width: 100, height: 38, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '302-C', size: '8 Marla', x: 1440, y: 195, width: 100, height: 38, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '303-C', size: '8 Marla', x: 1440, y: 235, width: 100, height: 38, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // ========================
            // EXISTING OLD PLOTS
            // ========================
            { id: '56-S', size: '5 Marla', x: 80, y: 320, width: 60, height: 30, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '55-S', size: '5 Marla', x: 80, y: 354, width: 60, height: 30, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '54-S', size: '5 Marla', x: 80, y: 388, width: 60, height: 30, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '53-S', size: '5 Marla', x: 80, y: 422, width: 60, height: 30, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '52-S', size: '5 Marla', x: 80, y: 456, width: 60, height: 30, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '51-S', size: '5 Marla', x: 80, y: 490, width: 60, height: 30, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // NEW: Top row - 236-C to 250-C (15 plots aligned with bottom rows)
            { id: '236-C', size: '5 Marla', x: 150, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '237-C', size: '5 Marla', x: 210, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '238-C', size: '5 Marla', x: 270, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '239-C', size: '5 Marla', x: 330, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '240-C', size: '5 Marla', x: 390, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '241-C', size: '5 Marla', x: 450, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '242-C', size: '5 Marla', x: 510, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '243-C', size: '5 Marla', x: 570, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '244-C', size: '5 Marla', x: 630, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '245-C', size: '5 Marla', x: 690, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '246-C', size: '5 Marla', x: 750, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '247-C', size: '5 Marla', x: 810, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '248-C', size: '5 Marla', x: 870, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '249-C', size: '5 Marla', x: 930, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '250-C', size: '5 Marla', x: 990, y: 320, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // NEW: Bottom row - 235-C to 221-C (15 plots)
            { id: '235-C', size: '5 Marla', x: 150, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '234-C', size: '5 Marla', x: 210, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '233-C', size: '5 Marla', x: 270, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '232-C', size: '5 Marla', x: 330, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '231-C', size: '5 Marla', x: 390, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '230-C', size: '5 Marla', x: 450, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '229-C', size: '5 Marla', x: 510, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '228-C', size: '5 Marla', x: 570, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '227-C', size: '5 Marla', x: 630, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '226-C', size: '5 Marla', x: 690, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '225-C', size: '5 Marla', x: 750, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '224-C', size: '5 Marla', x: 810, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '223-C', size: '5 Marla', x: 870, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '222-C', size: '5 Marla', x: 930, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '221-C', size: '5 Marla', x: 990, y: 425, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // ========================
            // EXISTING OLD PLOTS (BOTTOM SECTION - BELOW ROAD) - DO NOT CHANGE POSITIONS
            // ========================

            // Top Row: 202-C to 216-C (15 plots)
            { id: '202-C', size: '5 Marla', x: 150, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '203-C', size: '5 Marla', x: 210, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '204-C', size: '5 Marla', x: 270, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '205-C', size: '5 Marla', x: 330, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '206-C', size: '5 Marla', x: 390, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '207-C', size: '5 Marla', x: 450, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '208-C', size: '5 Marla', x: 510, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '209-C', size: '5 Marla', x: 570, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '210-C', size: '5 Marla', x: 630, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '211-C', size: '5 Marla', x: 690, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '212-C', size: '5 Marla', x: 750, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '213-C', size: '5 Marla', x: 810, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '214-C', size: '5 Marla', x: 870, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '215-C', size: '5 Marla', x: 930, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '216-C', size: '5 Marla', x: 990, y: 600, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // Third Row: Complete row of 45-S to 28-S (width: 44)
            { id: '45-S', size: '5 Marla', x: 150, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '44-S', size: '5 Marla', x: 200, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '43-S', size: '5 Marla', x: 250, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '42-S', size: '5 Marla', x: 300, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '41-S', size: '5 Marla', x: 350, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '40-S', size: '5 Marla', x: 400, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '39-S', size: '5 Marla', x: 450, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '38-S', size: '5 Marla', x: 500, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '37-S', size: '5 Marla', x: 550, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '36-S', size: '5 Marla', x: 600, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '35-S', size: '5 Marla', x: 650, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '34-S', size: '5 Marla', x: 700, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '33-S', size: '5 Marla', x: 750, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '32-S', size: '5 Marla', x: 800, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '31-S', size: '5 Marla', x: 850, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '30-S', size: '5 Marla', x: 900, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '29-S', size: '5 Marla', x: 950, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '28-S', size: '5 Marla', x: 1000, y: 700, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // Left Side S-plots (5 plots stacked vertically)
            { id: '50-S', size: '5 Marla', x: 80, y: 600, width: 60, height: 35, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '49-S', size: '5 Marla', x: 80, y: 638, width: 60, height: 35, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '48-S', size: '5 Marla', x: 80, y: 676, width: 60, height: 35, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '47-S', size: '5 Marla', x: 80, y: 714, width: 60, height: 35, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '46-S', size: '5 Marla', x: 80, y: 752, width: 60, height: 35, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // ========================
            // RIGHT SIDE PLOTS (AFTER VERTICAL ROAD 30' WIDE)
            // ========================

            // LEFT COLUMN - Portrait plots (220-C, 219-C, 218-C, 217-C, 27-S, 26-S)
            { id: '220-C', size: '5 Marla', x: 1105, y: 495, width: 80, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '219-C', size: '5 Marla', x: 1105, y: 549, width: 80, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '218-C', size: '5 Marla', x: 1105, y: 603, width: 80, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '217-C', size: '5 Marla', x: 1105, y: 657, width: 80, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '27-S', size: '5 Marla', x: 1105, y: 710, width: 38, height: 80, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '26-S', size: '5 Marla', x: 1148, y: 710, width: 38, height: 80, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // TOP ROW - Landscape plots (250-C, 249-C, 248-C)
            { id: '250-C', size: '5 Marla', x: 1105, y: 336, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '249-C', size: '5 Marla', x: 1105, y: 389, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '248-C', size: '5 Marla', x: 1105, y: 442, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // RIGHT GROUP - Portrait plots (256-C to 251-C)
            { id: '254-C', size: '5 Marla', x: 1295, y: 442, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '255-C', size: '5 Marla', x: 1295, y: 389, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '256-C', size: '5 Marla', x: 1295, y: 336, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '253-C', size: '5 Marla', x: 1175, y: 442, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '252-C', size: '5 Marla', x: 1175, y: 389, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '251-C', size: '5 Marla', x: 1175, y: 336, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // NEW RIGHT SIDE - Portrait plots (257-C, 258-C, 259-C) - Right of the vertical road
            { id: '257-C', size: '5 Marla', x: 1370, y: 336, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '258-C', size: '5 Marla', x: 1370, y: 389, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '259-C', size: '5 Marla', x: 1370, y: 442, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // ADDITIONAL RIGHT SIDE - Portrait plots (260-C, 261-C, 262-C) - Right of the second vertical road
            { id: '262-C', size: '5 Marla', x: 1485, y: 336, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '261-C', size: '5 Marla', x: 1485, y: 389, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '260-C', size: '5 Marla', x: 1485, y: 442, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '263-C', size: '5 Marla', x: 1485, y: 283, width: 65, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' }
        ]
    },
