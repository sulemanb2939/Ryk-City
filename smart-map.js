...
const mapConfig = [
...

    {
        ...
        name: 'Block C',
        gridArea: '11 / 3 / 12 / 4',
        style: 'height: 800px; width: 1400px; position: relative;',
        roads: [
            // Separator road between new (top) and existing (bottom) plots
            { name: "ROAD 30' WIDE", y: 385, width: 1020, x: 80 },
            // Vertical road on the right side of plots
            { name: "ROAD 30' WIDE", x: 1055, y: 165, width: 40, height: 467, isVertical: true }
        ],
        plots: [
            // ========================
            // NEW PLOTS (TOP SECTION - ABOVE ROAD)
            // ========================

            // NEW: Left Side S-plots (51-S to 56-S) - Vertical strip on left
            { id: '56-S', size: '5 Marla', x: 80, y: 165, width: 60, height: 30, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '55-S', size: '5 Marla', x: 80, y: 199, width: 60, height: 30, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '54-S', size: '5 Marla', x: 80, y: 233, width: 60, height: 30, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '53-S', size: '5 Marla', x: 80, y: 267, width: 60, height: 30, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '52-S', size: '5 Marla', x: 80, y: 301, width: 60, height: 30, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '51-S', size: '5 Marla', x: 80, y: 335, width: 60, height: 30, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // NEW: Top row - 236-C to 250-C (15 plots aligned with bottom rows)
            { id: '236-C', size: '5 Marla', x: 150, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '237-C', size: '5 Marla', x: 210, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '238-C', size: '5 Marla', x: 270, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '239-C', size: '5 Marla', x: 330, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '240-C', size: '5 Marla', x: 390, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '241-C', size: '5 Marla', x: 450, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '242-C', size: '5 Marla', x: 510, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '243-C', size: '5 Marla', x: 570, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '244-C', size: '5 Marla', x: 630, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '245-C', size: '5 Marla', x: 690, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '246-C', size: '5 Marla', x: 750, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '247-C', size: '5 Marla', x: 810, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '248-C', size: '5 Marla', x: 870, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '249-C', size: '5 Marla', x: 930, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '250-C', size: '5 Marla', x: 990, y: 165, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // NEW: Bottom row - 235-C to 221-C (15 plots)
            { id: '235-C', size: '5 Marla', x: 150, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '234-C', size: '5 Marla', x: 210, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '233-C', size: '5 Marla', x: 270, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '232-C', size: '5 Marla', x: 330, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '231-C', size: '5 Marla', x: 390, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '230-C', size: '5 Marla', x: 450, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '229-C', size: '5 Marla', x: 510, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '228-C', size: '5 Marla', x: 570, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '227-C', size: '5 Marla', x: 630, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '226-C', size: '5 Marla', x: 690, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '225-C', size: '5 Marla', x: 750, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '224-C', size: '5 Marla', x: 810, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '223-C', size: '5 Marla', x: 870, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '222-C', size: '5 Marla', x: 930, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '221-C', size: '5 Marla', x: 990, y: 270, width: 55, height: 100, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            ...
            { id: '202-C', size: '5 Marla', x: 150, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '203-C', size: '5 Marla', x: 210, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '204-C', size: '5 Marla', x: 270, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '205-C', size: '5 Marla', x: 330, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '206-C', size: '5 Marla', x: 390, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '207-C', size: '5 Marla', x: 450, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '208-C', size: '5 Marla', x: 510, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '209-C', size: '5 Marla', x: 570, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '210-C', size: '5 Marla', x: 630, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '211-C', size: '5 Marla', x: 690, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '212-C', size: '5 Marla', x: 750, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '213-C', size: '5 Marla', x: 810, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '214-C', size: '5 Marla', x: 870, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '215-C', size: '5 Marla', x: 930, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '216-C', size: '5 Marla', x: 990, y: 445, width: 55, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // Third Row: Complete row of 45-S to 28-S (width: 44)
            { id: '45-S', size: '5 Marla', x: 150, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '44-S', size: '5 Marla', x: 200, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '43-S', size: '5 Marla', x: 250, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '42-S', size: '5 Marla', x: 300, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '41-S', size: '5 Marla', x: 350, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '40-S', size: '5 Marla', x: 400, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '39-S', size: '5 Marla', x: 450, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '38-S', size: '5 Marla', x: 500, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '37-S', size: '5 Marla', x: 550, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '36-S', size: '5 Marla', x: 600, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '35-S', size: '5 Marla', x: 650, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '34-S', size: '5 Marla', x: 700, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '33-S', size: '5 Marla', x: 750, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '32-S', size: '5 Marla', x: 800, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '31-S', size: '5 Marla', x: 850, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '30-S', size: '5 Marla', x: 900, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '29-S', size: '5 Marla', x: 950, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '28-S', size: '5 Marla', x: 1000, y: 545, width: 44, height: 90, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // Left Side S-plots (5 plots stacked vertically)
            { id: '50-S', size: '5 Marla', x: 80, y: 445, width: 60, height: 35, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '49-S', size: '5 Marla', x: 80, y: 483, width: 60, height: 35, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '48-S', size: '5 Marla', x: 80, y: 521, width: 60, height: 35, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '47-S', size: '5 Marla', x: 80, y: 559, width: 60, height: 35, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '46-S', size: '5 Marla', x: 80, y: 597, width: 60, height: 35, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            ...
            { id: '220-C', size: '5 Marla', x: 1105, y: 215, width: 35, height: 80, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '219-C', size: '5 Marla', x: 1105, y: 300, width: 35, height: 80, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '218-C', size: '5 Marla', x: 1105, y: 385, width: 35, height: 80, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '217-C', size: '5 Marla', x: 1105, y: 470, width: 80, height: 50, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '27-S', size: '5 Marla', x: 1105, y: 555, width: 35, height: 80, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '26-S', size: '5 Marla', x: 1145, y: 555, width: 35, height: 80, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // TOP ROW - Landscape plots (250-C, 249-C, 248-C)
            { id: '250-C', size: '5 Marla', x: 1145, y: 165, width: 70, height: 40, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '249-C', size: '5 Marla', x: 1220, y: 165, width: 70, height: 40, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '248-C', size: '5 Marla', x: 1295, y: 165, width: 70, height: 40, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },

            // RIGHT GROUP - Portrait plots (256-C to 251-C)
            { id: '256-C', size: '5 Marla', x: 1145, y: 210, width: 35, height: 80, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '255-C', size: '5 Marla', x: 1185, y: 210, width: 35, height: 80, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '254-C', size: '5 Marla', x: 1225, y: 210, width: 35, height: 80, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '253-C', size: '5 Marla', x: 1265, y: 210, width: 35, height: 80, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '252-C', size: '5 Marla', x: 1305, y: 210, width: 35, height: 80, price: 3500000, status: 'available', type: 'residential', block: 'Block C' },
            { id: '251-C', size: '5 Marla', x: 1345, y: 210, width: 35, height: 80, price: 3500000, status: 'available', type: 'residential', block: 'Block C' }
        ]
    },
